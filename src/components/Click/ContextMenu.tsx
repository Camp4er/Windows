...
interface ContextMenuProps {
  ...
  onClearRightClickedIcon: () => void; // Function to clear the rightClickedIcon state
}

export default function ContextMenu({ rightClickedIcon, onClearRightClickedIcon }: ContextMenuProps) {
  ...
  useEffect(() => {
    ...
    const handleClickAway = (event: MouseEvent) => {
      if (menuRef.current && !(menuRef.current as any).contains(event.target)) {
        ...
        onClearRightClickedIcon(); // Clear the rightClickedIcon when menu closes
      }
    };
  ...
  }, [onClearRightClickedIcon]); // Add onClearRightClickedIcon to the dependency array
  ...
  const handleOpenTerminal = () => {
    ...
    onClearRightClickedIcon(); // Clear the rightClickedIcon
  };
  ...
  const renderDesktopMenuItems = () => (
    <>
      ...
      >
        ...
        {showSortOptions && (
          <ul className="absolute left-full top-0 bg-gray-800 text-white shadow-md rounded-md p-2 text-sm w-48">
            <li className="hover:bg-gray-700 px-3 py-2 cursor-pointer">Name</li>
            <li className="hover:bg-gray-700 px-3 py-2 cursor-pointer">Size</li>
            <li className="hover:bg-gray-700 px-3 py-2 cursor-pointer">
              Item Type
            </li>
            <li className="hover:bg-gray-700 px-3 py-2 cursor-pointer">
