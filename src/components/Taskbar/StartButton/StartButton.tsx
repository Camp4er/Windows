...
const StartButton = () => {
  ...
  document.body.addEventListener("click", (event) => {
    ...
    const isStartButton = target.closest(".start-button") !== null;
  
    if (!isStartButton && !target.closest(".start-menu") && !target.closest(".scrollable")) {
      setIsOpen(false);
    }
  });
      ...
      {isOpen && (
        ...
        <div className="pb-2 px-10 search rounded">
          <div className="mt-2 flex justify-between items-center pt-2">
            <button data-app-button className="flex justify-center items-center gap-2 hover:bg-zinc-800 rounded-md py-2 px-3">
              <Image
                src="/icons/user.png"
                alt="hero image"
                width={30}
